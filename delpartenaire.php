    ...
    <head>
     ...
     <body>
         <div class="container admin">
            <div class="row">
                <h1><strong>Supprimer un partenaire</strong></h1>
                <form class="form" action="delpartenaire.php" role="form" method="POST">
                    <input type="hidden" name="id" value="<?php echo $id;?>"/>
                    <p class="alert alert-warning">Etes vous sur de vouloir supprimer ?</p>
                    <div class="form-actions">
                        <form action="partview.php" method="POST" name="suppression">
